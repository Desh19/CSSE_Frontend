...
//   <div className="bg-white rounded-xl shadow-lg overflow-hidden flex flex-col w-full">
//     {/* Image/Visual Area */}
//     <div className="h-56">
//       <img
//         src={imageUrl}
...
//           <img
//             src={GarbageTruck} // Replace with actual path
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <ServiceCard
            ...
            imageUrl={SpecialPickup}
            imageAlt="Jar with plant for special waste item"
            linkTo="/services/special-pickup" // Added navigation link
          />
          <ServiceCard
            title="Manage Regular Waste"
            description="Adjust your weekly waste collection schedule."
